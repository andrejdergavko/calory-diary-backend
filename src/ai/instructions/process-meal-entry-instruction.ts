...
Each request also includes a JSON array called "todayFoods" describing everything the user already logged earlier today. Each entry includes the food name, the quantity in grams, and the recorded calories, protein, fat, and carbs.
